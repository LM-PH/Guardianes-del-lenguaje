...
const MAPS = {
  pueblo_inicial:   { width: 50,  height: 50,  title: 'Pueblo Inicial (v200)'        },
...
function MainMap() {
  ...
  const boySkinTraductorRef = useImage('/sprites/boy_skin_traductor_v200.png?v=7070')
  const girlSkinTraductorRef = useImage('/sprites/girl_skin_traductor_v200.png?v=7070')
  const boySkinMaestroRef = useImage('/sprites/boy_skin_maestro_v200.png?v=7070')
  const girlSkinMaestroRef = useImage('/sprites/girl_skin_maestro_v200.png?v=7070')
