...
const MAPS = {
  pueblo_inicial:   { width: 50,  height: 50,  title: 'Pueblo Inicial (v7070)'        },
...
function MainMap() {
  ...
  // Trajes / Skins
  const boySkinExploradorRef = useImage('/sprites/boy_skin_explorador.png?v=7070')
  const girlSkinExploradorRef = useImage('/sprites/girl_skin_explorador.png?v=7070')
  const boySkinBibliotecarioRef = useImage('/sprites/boy_skin_bibliotecario.png?v=7070')
  ...
  const boySkinTraductorRef = useImage('/sprites/boy_skin_traductor_vFinal.png?v=7070')
  const girlSkinTraductorRef = useImage('/sprites/girl_skin_traductor_vFinal.png?v=7070')
  const boySkinMaestroRef = useImage('/sprites/boy_skin_maestro_vFinal.png?v=7070')
  const girlSkinMaestroRef = useImage('/sprites/girl_skin_maestro_vFinal.png?v=7070')
