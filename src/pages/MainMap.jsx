...
function MainMap() {
  ...
  // Trajes / Skins
  const boySkinExploradorRef = useImage('/sprites/boy_skin_explorador.png?v=6060')
  const girlSkinExploradorRef = useImage('/sprites/girl_skin_explorador.png?v=6060')
  const boySkinBibliotecarioRef = useImage('/sprites/boy_skin_bibliotecario.png?v=6060')
  const girlSkinBibliotecarioRef = useImage('/sprites/girl_skin_bibliotecario.png?v=6060')
  const boySkinArtistaRef = useImage('/sprites/boy_skin_artista.png?v=6060')
  const girlSkinArtistaRef = useImage('/sprites/girl_skin_artista.png?v=6060')
  const boySkinTraductorRef = useImage('/sprites/boy_skin_traductor_vFinal.png?v=6060')
  const girlSkinTraductorRef = useImage('/sprites/girl_skin_traductor_vFinal.png?v=6060')
  const boySkinMaestroRef = useImage('/sprites/boy_skin_maestro_vFinal.png?v=6060')
  const girlSkinMaestroRef = useImage('/sprites/girl_skin_maestro_vFinal.png?v=6060')
  const boySkinSabioRef = useImage('/sprites/boy_skin_sabio.png?v=6060')
  const girlSkinSabioRef = useImage('/sprites/girl_skin_sabio.png?v=6060')
