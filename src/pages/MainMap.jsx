...
function MainMap() {
  ...
  // Trajes / Skins
  const boySkinExploradorRef = useImage('/sprites/boy_skin_explorador.png?v=2222')
  const girlSkinExploradorRef = useImage('/sprites/girl_skin_explorador.png?v=2222')
  const boySkinBibliotecarioRef = useImage('/sprites/boy_skin_bibliotecario.png?v=2222')
  const girlSkinBibliotecarioRef = useImage('/sprites/girl_skin_bibliotecario.png?v=2222')
  const boySkinArtistaRef = useImage('/sprites/boy_skin_artista.png?v=2222')
  const girlSkinArtistaRef = useImage('/sprites/girl_skin_artista.png?v=2222')
  const boySkinTraductorRef = useImage('/sprites/boy_skin_traductor.png?v=2222')
  const girlSkinTraductorRef = useImage('/sprites/girl_skin_traductor.png?v=2222')
  const boySkinMaestroRef = useImage('/sprites/boy_skin_maestro.png?v=2222')
  const girlSkinMaestroRef = useImage('/sprites/girl_skin_maestro.png?v=2222')
  const boySkinSabioRef = useImage('/sprites/boy_skin_sabio.png?v=2222')
  const girlSkinSabioRef = useImage('/sprites/girl_skin_sabio.png?v=2222')
