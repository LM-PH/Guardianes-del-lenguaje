...
function Battle() {
  ...
  const getPlayerSpritePath = (pl) => {
    if (!pl || !pl.character) return '/sprites/boy_v18.png?v=1010';
    ...
    if (eqSkin && eqSkin !== 'default') {
      return `/sprites/${prefix}${eqSkin}.png?v=1010`;
    }
    return `/sprites/${isGirl ? 'girl_v18.png?v=1010' : 'boy_v18.png?v=1010'}`;
  };
