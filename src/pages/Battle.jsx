...
function Battle() {
  ...
  const getPlayerSpritePath = (pl) => {
    if (!pl || !pl.character) return '/sprites/boy_v18.png?v=7777';
    ...
    if (eqSkin && eqSkin !== 'default') {
      return `/sprites/${prefix}${eqSkin}.png?v=7777`;
    }
    return `/sprites/${isGirl ? 'girl_v18.png?v=7777' : 'boy_v18.png?v=7777'}`;
  };
